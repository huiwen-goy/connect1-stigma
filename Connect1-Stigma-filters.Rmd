...
## PTA: ROC curve
```{r, echo=FALSE}
m.age <- glm(Purchased_HA ~ Age, family = binomial("logit"), data = pta)
pred.age <- predict.glm(m.age, newdata = subset(pta, select=c('Age')), type = 'response')

m.hhie <- glm(Purchased_HA ~ HHIE_total, family = binomial("logit"), data = pta)
pred.hhie <- predict.glm(m.hhie, newdata = subset(pta, select=c('HHIE_total')), type = 'response')

m.pta <- glm(Purchased_HA ~ PTA4_better_ear, family = binomial("logit"), data = pta)
pred.pta <- predict.glm(m.pta, newdata = subset(pta, select=c('PTA4_better_ear')), type = 'response')
...
plotROC(data = pta, 
  ...
  plottitle = "PTA4 better ear > 25 dB HL", 
...
## HHIE: ROC curve
```{r, echo=FALSE}
m.age <- glm(Purchased_HA ~ Age, family = binomial("logit"), data = hhie)
pred.age <- predict.glm(m.age, newdata = subset(hhie, select=c('Age')), type = 'response')

m.hhie <- glm(Purchased_HA ~ HHIE_total, family = binomial("logit"), data = hhie)
pred.hhie <- predict.glm(m.hhie, newdata = subset(hhie, select=c('HHIE_total')), type = 'response')

m.pta <- glm(Purchased_HA ~ PTA4_better_ear, family = binomial("logit"), data = hhie)
pred.pta <- predict.glm(m.pta, newdata = subset(hhie, select=c('PTA4_better_ear')), type = 'response')
...
## Hearing ability: ROC curve
```{r, echo=FALSE}
m.age <- glm(Purchased_HA ~ Age, family = binomial("logit"), data = ab)
pred.age <- predict.glm(m.age, newdata = subset(ab, select=c('Age')), type = 'response')

m.hhie <- glm(Purchased_HA ~ HHIE_total, family = binomial("logit"), data = ab)
pred.hhie <- predict.glm(m.hhie, newdata = subset(ab, select=c('HHIE_total')), type = 'response')

m.pta <- glm(Purchased_HA ~ PTA4_better_ear, family = binomial("logit"), data = ab)
pred.pta <- predict.glm(m.pta, newdata = subset(ab, select=c('PTA4_better_ear')), type = 'response')
